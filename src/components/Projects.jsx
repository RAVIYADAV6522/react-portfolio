...
function Projects() {
  return (
    <div className="pb-4">
      <motion.h2
        className="my-20 text-center text-4xl bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent"
        animate={{
          x: [-25, 0, 25, -25],
        }}
        transition={{
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center">
              <div className="w-full max-w-xl lg:w-3/4">
                ...
                {project.technologies.map((tech, index) => (
                  <motion.span
                    className="mr-2  inline-block rounded shadow-[0_0_15px_rgba(255,255,255,0.2)] p-2 text-sm font-medium  bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent"
                    key={index}
                    whileHover={{
                      scale: 1.1,
                    }}
